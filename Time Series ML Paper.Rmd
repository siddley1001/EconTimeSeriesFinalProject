...
y_vde = final_merged_vde$coredata.volvde.
...
y_vht = final_merged_vht$coredata.volvht.
...
enet_vde = HDeconometrics::ic.glmnet(x_vde, y_vde, crit = "bic", alpha=1, lambda = enetfit.vde$bestTune$lambda)
coef(enet_vde)
enet_vde$ic

enet_vht = HDeconometrics::ic.glmnet(x_vht, y_vht, crit = "bic", alpha=1, lambda = enetfit.vht$bestTune$lambda)
coef(enet_vht)
enet_vht$ic
```
